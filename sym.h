 ...
 *  - Mirroring through a plane between the L and the D face (2 options)
 ...
 * `s` used to perform this transformation, we store in this table not only `sc` but directly `N_SYMS_SUB * sc + s` to
